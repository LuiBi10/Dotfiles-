...
return {
  {
    ...
    opts = {
      ...
      workspaces = {
        {
          name = "English Note", -- Name of the workspace
          path = "/home/luibi/Documents/Obsidian/Notes/"
        },
      },
      ...
      notes_subdir = "random notes", -- Subdirectory for notes
      new_notes_location = "random notes", -- Location for new notes
